...
const campaignConfig: Record<string, { pill: string; dot: string }> = {
  ...
  scheduled: { pill: 'bg-blue-500/8 text-blue-600 border border-blue-500/15',                                    dot: 'bg-blue-500' },
  running:   { pill: 'bg-emerald-500/8 text-emerald-600 border border-emerald-500/15',                           dot: 'bg-emerald-500' },
  paused:    { pill: 'bg-amber-500/8 text-amber-600 border border-amber-500/15',                                 dot: 'bg-amber-500' },
...
const contactConfig: Record<string, { pill: string; dot: string }> = {
  ...
  active:       { pill: 'bg-emerald-500/8 text-emerald-600 border border-emerald-500/15',                           dot: 'bg-emerald-500' },
  completed:    { pill: 'bg-[var(--bg-elevated)] text-[var(--text-secondary)] border border-[var(--border-subtle)]', dot: 'bg-[var(--text-tertiary)]' },
  replied:      { pill: 'bg-blue-500/8 text-blue-600 border border-blue-500/15',                                    dot: 'bg-blue-500' },
  bounced:      { pill: 'bg-[var(--error-bg)] text-[var(--error)] border border-[var(--error-border)]',             dot: 'bg-[var(--error)]' },
  unsubscribed: { pill: 'bg-amber-500/8 text-amber-600 border border-amber-500/15',                                 dot: 'bg-amber-500' },

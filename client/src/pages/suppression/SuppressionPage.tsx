            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--border-subtle)] bg-[var(--bg-elevated)]/60">
                  <th className="text-left px-4 py-2.5 font-data text-[10px] font-medium text-[var(--text-tertiary)]">Email</th>
                  <th className="text-left px-4 py-2.5 font-data text-[10px] font-medium text-[var(--text-tertiary)]">Reason</th>
                  <th className="text-left px-4 py-2.5 font-data text-[10px] font-medium text-[var(--text-tertiary)]">Notes</th>
                  <th className="text-left px-4 py-2.5 font-data text-[10px] font-medium text-[var(--text-tertiary)]">Added</th>
